...
import { Save, RefreshCw, Moon, Sun, HelpCircle } from 'lucide-react';
    ...
    <div className={`${bgColor} min-h-screen p-4 lg:p-8`}>
      <div className="max-w-6xl mx-auto">
        <div className="mb-6 lg:mb-8">
          <h1 className={`text-2xl lg:text-3xl font-bold ${textColor} mb-2`}>Interface</h1>
          <p className={secondaryTextColor}>Customize the application appearance and behavior</p>
        </div>
